...
import './AboutDealers.css'

function AboutDealers() {
  ...
  return (
      ...
      <IconContext.Provider value= {{color: '#fff'}}>
        ...
        <div className='aboutDealers'>
          <h1>About Dealers</h1>
          <p>Dealers will be posting their information and contact here</p>
        </div>
